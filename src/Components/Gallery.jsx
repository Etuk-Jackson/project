...
import { galleryTop, galleryBottom } from "../Constants/Index"
...
function Gallery() {
  return (
    ...
    className='flex overflow-hidden mt-[200px] font-sans  flex-col p-[65px 50px] gap-14 justify-center items-center'>
      ...
      <motion.p 
      variants={textVariant()}
      className="xs:mt-[10px] sm:mt-[2.5] text-center md:mt-3 text-[20px] sm:w-[411px] sm:h-[90px] flex items-center leading-[30px] tracking-[0.2px] md:w-[700px] md:h-[60px] p-[5] pl-[30px]">We focus on ergonomics and meeting you where you work. It's only a keystroke away.</motion.p>
      ...
      <div className="">
      <button className='w-[139px] h-[50px] rounded-[3px] border mt-2'>Learn more</button>
      </div>
    </motion.div>
  )
}
